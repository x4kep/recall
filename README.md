...
Users create **Decks** of **Cards**. Each card is a rich learning unit — not just a question and answer, but also context explaining *why* the topic matters, a simple example, three real-world use cases, and a difficulty tag.
...
- **Voice Answer Mode** *(Premium)* — Speak your answer, AI rates it 1–10 with explanation
...
- **Voice Mode** *(Premium)* — Hands-free study for commutes
...
- **Cloud Sync** *(Phase 2)* — Supabase auth + delta sync across devices
